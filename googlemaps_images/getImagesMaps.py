...
class GoogleMapDownloader:
    ...
    def __init__(self, lat = 0, lng = 0, zoom=12):
        """
    ...
    def generateImage(self, satelite = False, **kwargs):
        """
...
def main():
    ...
    gmd = GoogleMapDownloader(-29.70751,-53.7223736, 20)
